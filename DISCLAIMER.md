...
**Copyright** in the book text, diagrams, and written expression of these methodologies is held by Viquar Khan (2019-2026). Source code in this repository is under the MIT License. Book prose and figures are under CC BY-NC-ND 4.0. Details: [LICENSING.md](LICENSING.md).
