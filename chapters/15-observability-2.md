...
## 15.1 What this chapter adds

Chapter 8 already defined monitoring versus observability, the three pillars, and why the fields you emit bound the questions you can answer. I am not repeating that lecture. This chapter is about cost, sampling, and staying sighted at scale: how you spend a finite telemetry budget on the requests that matter, and how you keep a second view of the estate so a missing instrument does not become a missing truth. Kernel collection as a *mechanism* lives in Chapter 8. The use of that kernel graph as a cross-check against traces lives here.
